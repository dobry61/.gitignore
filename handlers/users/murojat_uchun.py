...
async def bot_echo(message: types.Message,state:FSMContext):
    await message.answer(text="Bosh menyu",reply_markup=menu_button)
...
#     await message.answer(text="Murojaatingiz adminga yuborildi✅",reply_markup=menu_button)
#     await state.finish()
#
#
...
# async def bot_echo(message: types.Message, state: FSMContext):
#
#     await message.answer(text="murojaat jo'natilmadi❌",reply_markup=menu_button)
#     await state.finish()